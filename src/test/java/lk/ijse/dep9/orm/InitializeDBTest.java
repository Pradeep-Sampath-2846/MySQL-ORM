...
class InitializeDBTest {
    ...
    void initialize() {
        assertDoesNotThrow(()->{
            InitializeDB.initialize("localhost","3306","dep9_orm","root","KPsuneetha@123","lk.ijse.dep9.orm.entity");
        });
//            assertDoesNotThrow(()->{
//                try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/dep9_orm", "root", "KPsuneetha@123");){
